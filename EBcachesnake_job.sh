...
export LOGDIR=/fast/users/${USER}/scratch/lox/EBcache/${JOB_ID}
...
snakemake --snakefile EBcacheSnakefile --use-conda --restart-times 3 --rerun-incomplete --drmaa "$DRMAA" -j 3000 -p -r -k
